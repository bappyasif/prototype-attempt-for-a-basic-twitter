    ...
    return (
        <div className='category-container' style={{ backgroundColor: clicked && 'rgba(29, 155, 240, 1)' }}>
            ...
            <div className='svgs-div'>
                <div className='plus-svg' style={{ transform: 'scale(.8)' }}>{plusSvg()}</div>
                <div className='remove-svg' style={{ transform: 'scale(.8)' }}>{removeSvg()}</div>
            </div> */}
            ...
            {/* {
                clicked
                    ?
                    <div className='svgs-div'>
                        <div className='check-mark-svg' style={{ transform: 'scale(.8)' }} onClick={handleClicked}>{checkMarkSvg()}</div>
                    </div>
                    :
                    <div className='svgs-div'>
                        <div className='plus-svg' style={{ transform: 'scale(.8)' }} onClick={handleClicked}>{plusSvg()}</div>
                        <div className='remove-svg' style={{ transform: 'scale(.8)' }}>{removeSvg()}</div>
                    </div>
            } */}
            {/* <div className='svgs-div'>
