...
function AllTweetsPage({ tweetData, onlyMedias, removeSpeceficArrayItem }) {
    ...
    let renderTweet = (item) => {
        ...
        return <RenderTweetDataComponent content={content} removeSpeceficArrayItem={removeSpeceficArrayItem} />
    }
...
let TweeetTop = ({ID, removeSpeceficArrayItem}) => {
    ...
    return (
        <div className='tweet-top'>
            ...
            { clicked && <RenderDropdownForTweetMoreOptions ID={ID} removeSpeceficArrayItem={removeSpeceficArrayItem} /> }
        </div>
    )
}
...
let RenderOptions = ({item, ID, removeSpeceficArrayItem}) => {
    ...
    return (
        <div className='option-container' id={item.title == 'Delete' ? ID : ''} onClick={handleClickAction}>
...
let RenderTweetDataComponent = ({ content, removeSpeceficArrayItem }) => {
    // let [hoveredID, setHoveredID] = useState('')
