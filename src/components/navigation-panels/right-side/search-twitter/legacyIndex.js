...
let SearchDropdown = ({ searchedKeywords, setSearchedKeywords, focused, setFocused }) => {
    // let [searchedKeywords, setSearchedKeywords] = useState([])
    ...
    // let renderAlreadySearchedKeywords = searchedKeywords.map((item, idx, self) => {self ? <div key={item.keyword} className='keywords-section'><span className='search-icon'>{searchIcon(null, 'scale(1.3)')}</span><span className='searched-keywords'>{item.keyword}</span><span className='remove-icon' id={item.keyword} onClick={handleSearchKeywordRemoval}>{removeIcon()}</span></div> : 'try searching for people, topics or keywords' } )
    ...
    // let renderAlreadySearchedKeywords = searchedKeywords.map((item, idx, self) => <div key={item.keyword} className='keywords-section'>{!self ? 'Trye Searching for people, topics or keywords' : <span className='search-icon'>{searchIcon(null, 'scale(1.3)')}</span><span className='searched-keywords'>{item.keyword}</span><span className='remove-icon' id={item.keyword} onClick={handleSearchKeywordRemoval}>{removeIcon()}</span>}</div>)
    ...
    //     let searchedDropdown = document.querySelector('#search-dropdown-container');
    //     // if (allElements && !searchedDropdown) setFocused('false');
    //     allElements.onclick = (evt) => {
    //         console.log(evt.target.id)
    //         // if(evt.target.id != 'search-dropdown-container') {
    //         //     setFocused(false);
    //         //     // console.log('here!!', focused)
    //         // }
    //         // if(evt.target != searchedDropdown && searchedDropdown.offsetParent != null) {
    //         //     setFocused(false);
    //         //     console.log('here!!', focused)
    //         // }
    //         if(evt.target != searchedDropdown && searchedDropdown.offsetParent != null) {
    ...
    return <div id='search-dropdown-container'>
        ...
        {/* {renderAlreadySearchedKeywords} */}
        {/* {renderAlreadySearchedKeywords.length == 0 &&  'Try searching for people, topics or keywords'} */}
        {/* {console.log(renderAlreadySearchedKeywords.length)} */}
    </div>
}
